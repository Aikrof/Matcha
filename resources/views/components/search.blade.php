            ...
            <div class="form-group">
              <label for="garages">Filter by</label>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="multi-range multi-range-double filter_range_age w-60" data-lbound='10' data-ubound='60'>
                ...
                <div class="row">
                   <label class="name_SF">Location Distance:</label>
                    <div class="col-md-12">
                        <div class='multi-range multi-range-one-km less_100 distance_inp w-60' data-lbound='0'>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       <div class='multi-range multi-range-one filter_rating w-60' data-lbound='0'>
